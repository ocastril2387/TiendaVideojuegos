...
public class JuegoJPanel extends JPanel implements ActionListener
{
    ...
    public void actualizarPanel(Juego juego)
    {
        ...
        txtPrecioJuego.setText( juego.getPrecio()+ "" );
        txtDisponibles.setText( juego.getCantidadDisponible()+ "" );
        txtVendidas.setText( juego.getCantidadVendida()+ "" );        
